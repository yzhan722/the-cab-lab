// Build a known layout of every wired native module, using the same addCabinet
...
function addBox(moduleId, world, side) {
  const inset = getModule(moduleId).frontInset != null ? getModule(moduleId).frontInset : fpt();
  const fit = fitBoxFacing(world, side, inset);
...
/**
 * Replace the job with a box space and one of each native module.
...
export function buildQaScene() {
  ...
  job.addCabinet("bedBox", { x: BOX.width / 2 + 1530 / 2, y: 700 + 1900, z: 0, rotZ: 180 }, { W: 1530, D: 1900, H: 420 });
  job.addCabinet("bedSideTable", { x: 400, y: 700 + 400, z: 0, rotZ: 180 }, { W: 280, D: 400, H: 420 });

  addBox("smallCabinet", { x0: 0, y0: 750, z0: 0, W: 560 + door, D: 600, H: 720 }, { axis: "x", dir: 1 });
  addBox("tallCabinet", { x0: 0, y0: 1400, z0: 0, W: 584 + door, D: 600, H: 2000 }, { axis: "x", dir: 1 });
  addBox("kitchenCabinet", { x0: 0, y0: 2050, z0: 0, W: 560 + door, D: 800, H: 870 }, { axis: "x", dir: 1 });

  const lounge = addBox("loungeGenerator", { x0: BOX.width - 600, y0: 900, z0: 0, W: 600, D: 2000, H: 420 }, { axis: "x", dir: -1 });
  loungePath(lounge, [{ x: 0, y: 0 }, { x: 0, y: 2000 }], 600, 420, { x: 300, y: 1000 });

  addBox("overheadCabinet", {
    x0: 200, y0: BOX.depth - (350 + door), z0: H - 400, W: 1200, D: 350 + door, H: 400,
  }, { axis: "y", dir: -1 });
  addBox("uShapeOverheadCabinet", {
    x0: 1600, y0: BOX.depth - 900, z0: H - 400, W: 1400, D: 900, H: 400,
  }, { axis: "y", dir: -1 });
...
export const QA_SHOTS = [
  ...
  { tag: "tallCabinet", moduleId: "tallCabinet" },
...
export function buildQaModule(shot) {
  ...
  if (shot.moduleId === "bedroom") {
    ...
    job.addCabinet("bedroom", { x: BOX.width, y: 700, z: 0, rotZ: 180 }, { W: BOX.width, D: 700, H: 1965 });
    target = job.addCabinet("bedBox", { x: BOX.width / 2 + 1530 / 2, y: 700 + 1900, z: 0, rotZ: 180 }, { W: 1530, D: 1900, H: 420 });
  } else if (shot.moduleId === "bedSideTable") {
    job.addCabinet("bedroom", { x: BOX.width, y: 700, z: 0, rotZ: 180 }, { W: BOX.width, D: 700, H: 1965 });
    job.addCabinet("bedBox", { x: BOX.width / 2 + 1530 / 2, y: 700 + 1900, z: 0, rotZ: 180 }, { W: 1530, D: 1900, H: 420 });
    target = job.addCabinet("bedSideTable", { x: 400, y: 700 + 400, z: 0, rotZ: 180 }, { W: 280, D: 400, H: 420 });
  } else if (shot.moduleId === "smallCabinet") {
    target = addBox("smallCabinet", { x0: 200, y0: 200, z0: 0, W: 600, D: 560 + door, H: 720 }, { axis: "y", dir: -1 });
  } else if (shot.moduleId === "tallCabinet") {
  ...
  } else if (shot.moduleId === "loungeGenerator" && shot.style === "L") {
    target = addBox("loungeGenerator", { x0: 200, y0: 200, z0: 0, W: 2000, D: 1500, H: 420 }, { axis: "y", dir: -1 });
    loungePath(target, [{ x: 0, y: 0 }, { x: 2000, y: 0 }, { x: 2000, y: 1500 }], 600, 420, { x: 1000, y: 300 });
  } else if (shot.moduleId === "loungeGenerator") {
    target = addBox("loungeGenerator", { x0: 200, y0: 200, z0: 0, W: 2000, D: 600, H: 420 }, { axis: "y", dir: -1 });
    loungePath(target, [{ x: 0, y: 0 }, { x: 2000, y: 0 }], 600, 420, { x: 1000, y: 300 });
    ...
    target = addBox("uShapeOverheadCabinet", {
      x0: 200, y0: BOX.depth - 900, z0: BOX.height - 400, W: 1400, D: 900, H: 400,
    }, { axis: "y", dir: -1 });
  }
