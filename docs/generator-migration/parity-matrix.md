...
| lounge | I/L/PARALLEL/U bbox | oracle vs native | 0.01 mm | PASS | U matches oracle because both fall through to L |
| lounge | U_SHAPE geometry | Fusion generator | L fallback | SOURCE_AMBIGUITY | Fusion does not implement U at this SHA |
...
| lounge | every Fusion UI control | Fusion plugin UI | right panel | INTENTIONAL_DIVERGENCE | Style, lids, avoidance, L/PARALLEL dims. Hinge/lock/groove not in the form |
